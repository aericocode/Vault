// Dual-environment module: this exact file is BOTH the server's decision
// matrix (require('../../player-lib/playback-decide.js') from
// lib/stream/decide.js) and a plain <script> the viewer loads before
// filters.js, where it lands on window.VaultPlaybackDecide. One source of
// truth, so a chip and the server can never disagree about a file.
(function () {
  'use strict';
  ...
  if (typeof window !== 'undefined') window.VaultPlaybackDecide = API;
})();
