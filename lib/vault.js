...
const vault = {
  ...
  async setPassword(pass) {
    ...
    // an FFmpeg child outliving this call keeps writing plaintext segments into
    // its temp directory while the library around it is being encrypted.
    ...
    // Nothing to purge for streaming: remuxed segments are never stored, in
    // either mode. stopAll() above already dropped the in-memory rings.
    this.touch();
