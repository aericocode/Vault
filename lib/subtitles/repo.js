/**
 * Subtitles — persistence in the main vault.db (SUBTITLES_SPEC §5.1).
 *
...
const TRACKS_DIR = envVar('SUBS') || path.join(config.paths.thumbnailDir, 'subtitles');
 ...
 *   - redirected non-vault  → the redirected VAULT_SUBS root itself
