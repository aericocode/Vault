 ...
 * (thumbnailDir, tempDir, temp_audio — overridable via VIDEO_TAGGER_THUMBS /
 * VIDEO_TAGGER_TEMP / VIDEO_TAGGER_TEMP_AUDIO, or relocated wholesale when the
...
const PATTERNS = {
  ...
  // redirected subtitles root (VIDEO_TAGGER_SUBS) — see lib/subtitles/repo.js,
...
function _unrecognizedEntries(dir, kind) {
  ...
  return { missing: false, unrecognized };
}
