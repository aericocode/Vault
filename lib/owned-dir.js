...
const MARKER_CONTENT =
  'Created by Vault. It marks this directory as an app-managed cache/temp directory.\n' +
...
const PATTERNS = {
  ...
  // lib/stream/session.js (one mkdtemp dir per live remux producer).
  temp: {
    fileRx: [
    ...
    dirRx: [
      ...
      /^stream-\d+-[A-Za-z0-9]{6}$/,      // stream-{mediaId}-{mkdtemp} remux session
    ],
