...
|---|---|---|---|---|
| **6–8 GB** | `minicpm-v-4.6-abliterated-max` | `q8_0` | `WHISPER_MODEL=small` | One instance with 1 worker (CLI: `VISION_WORKERS=1`). Slower but fine. |
...
| `VAULT_DB_PASSWORD` | *(none)* | Auto-unlock an encrypted Vault at boot |
